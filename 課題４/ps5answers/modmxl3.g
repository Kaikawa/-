new , 10000;
screen on;
output file=out3.txt reset;
print "This program estimates a mixed logit with a fixed price coef and independent normals for the other coefficients.";
...
@starting values in this order: mean1, std1, mean2, std2, etc.@
b={-.857, -.183, 0.1, 2.098, 1. , 1.525, 0.8, -8.285, 2.0, -8.53, 2.0};
...
n=zeros(1,1);                       @Zero for the standard deviation of the price coef.@
b=b[1,.]|n|b[2:rows(b),.];          @Add the zero to the parameter vector.@
