...
set v5=beta[1]*ic5*(.9) + beta[2]*oc5 
...
set v5=beta[1]*ic5 + beta[2]*oc5 
set v6=beta[1]*(ic3+200) + beta[2]*oc3*(.75) + beta[5]

set denom=exp(v1)+exp(v2)+exp(v3)+exp(v4)+exp(v5)+exp(v6)
